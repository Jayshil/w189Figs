...
def evaluate_pytransit_CowanPC_model(times, fluxes, errors, fltr, per, bjd0, rprs, ar, mst, rst, vsini,\
                                     tpole, phi, lamp, bb1, E, C1, D1, C2, D2, mflx, sigw, LIN=False,\
                                     lin_vecs=None, thetas=None, GP=False, GP_S0=None, GP_Q=None, GP_rho=None, LTTD=True):
    ...
    ## Phase curve (Cowan & Agol 2008 phase curve model)
